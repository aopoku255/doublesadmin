...
const authProtectedRoutes = [
  { path: "/upcoming-events", component: <Events /> },
  ...
  { path: "/appointment", component: <Calendar /> },
  ...
  { path: "/event-registrations/:eventId", component: <EcommerceCustomers /> },
