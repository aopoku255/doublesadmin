...
export const getAllEvents = () => api.get(url.GET_ALL_EVENTS);
...
export const addEvents = (data) =>
  api.create(url.ADD_EVENTS, data, {
...
export const getAdmin = () => api.get(url.GET_ADMINS);
export const addAdmin = (team) => api.create(url.ADD_ADMINS, team);
